package com.isu.myborutoapp.presentation.componenets
...
import com.isu.myborutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.isu.myborutoapp.ui.theme.StarColor
import com.isu.myborutoapp.ui.theme.topAppBarBackgroundColor
import com.isu.myborutoapp.ui.theme.topAppBarContentColor
...
fun HomeTopBar(onSearchClicked: () -> Unit = {}) {
    TopAppBar(title = {
        ...
        backgroundColor = MaterialTheme.colors.topAppBarBackgroundColor, actions = {
            ...
            {
                Icon(imageVector = Icons.Default.Search, contentDescription = stringResource(R.string.search_con))
            }
        })
}
